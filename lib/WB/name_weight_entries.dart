...
class NameWeightEntries extends StatefulWidget {
  final void Function() onComplete;

  const NameWeightEntries({super.key, required this.onComplete});

  @override
  State<NameWeightEntries> createState() => _NameWeightEntriesState();
}

class _NameWeightEntriesState extends State<NameWeightEntries> {
